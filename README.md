...
- 🎯 Entry points to execute your program using `python -m <rekt_summarizer>` or `$ rekt_summarizer` with basic CLI argument parsing.
...
```bash
pip install rekt_summarizer
```

## Usage

```py
from rekt_summarizer import BaseClass
from rekt_summarizer import base_function
